...
void portf_PairTrading::CreateTimeSharingplan() {
	...
	delta_chart_->yAxis->setRange(-1, 2);
	...
	std_dev_up_toolbtn_->setStyleSheet(tr("color:green"));
	...
	std_dev_down_toolbtn_->setStyleSheet(tr("color:red"));
	...
	//delta_ma_chart_->setFixedHeight(400);	
	...
	delta_ma_line_->setPen(QPen(Qt::black));
	...
	std_dev_down_line_->setPen(QPen(Qt::red));
}
